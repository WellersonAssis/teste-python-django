...
class Aluno(Pessoa):
        ...
        data_nascimento = models.DateField('Data de Nascimento', blank=True,help_text='Formato DD/MM/AAAA')
...
class Disciplina(models.Model):
        ...
        nome = models.CharField('Nome',max_length=100)
        carga_horaria = models.IntegerField('Obrigatória',default=True)
        obrigatoria = models.BooleanField('Obrigatótia',default=True)
