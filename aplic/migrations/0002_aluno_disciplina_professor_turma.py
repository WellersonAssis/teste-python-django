# Generated by Django 2.2.19 on 2022-09-07 14:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento', models.DateField(blank=True, help_text='Formato DD/MM/AAAA', verbose_name='Data de Nascimento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100, verbose_name='Nome')),
                ('carga_horaria', models.IntegerField(default=True, verbose_name='Obrigatória')),
                ('obrigatoria', models.BooleanField(default=True, verbose_name='Obrigatótia')),
